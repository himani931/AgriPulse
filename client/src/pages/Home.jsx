...
export default function Home() {
  ...
  const moisturePenaltyPct = isMoistureHigh
    ? Number(((moisture - 12.0) * 0.75).toFixed(2))
    : 0;
  ...
  const content = {
    en: {
      ...
      heroSub:
        "A modern digital procurement ecosystem connecting local APMC mandis, dynamic gate tokens, automated weighbridges, and instantaneous Direct Benefit Transfer (DBT) settlements.",
      ...
      stats: [
        {
          ...
          val: "1,420+",
          sub: "Digitally synchronized",
        },
        {
          label: "Total MSP Disbursed",
          val: "₹1,418 Cr+",
          sub: "Directly into farmer A/Cs",
        },
        {
          label: "Certified Procurement",
          val: "5.2M Quintals",
          sub: "Rabi & Kharif records",
        },
        {
          label: "Average Gate Turnaround",
          val: "42 Mins",
          sub: "Reduced from 16+ hours",
        },
      ],
      stepsTitle: "The End-to-End Procurement Journey",
      stepsSub:
        "From field dispatch to certified bank credit in four streamlined stages",
      mspTableTitle: "Current Season Government MSP Rates",
      mspTableSub:
        "Official gazette floor prices for direct procurement centers",
      schemesTitle: "Central Government Farmer Welfare Schemes",
      schemesSub:
        "Explore official portals, eligibility frameworks, and direct application links",
      workspacesTitle: "Role-Based Operational Consoles",
      workspacesSub:
        "Specialized tools built for agricultural logistics and transparency",
    },
    hi: {
      ...
      heroSub:
        "एक आधुनिक डिजिटल कृषि खरीद नेटवर्क जो मंडियों, डिजिटल गेट टोकन, स्वचालित तौल और सीधे बैंक खाते में भुगतान को जोड़ता है।",
      ctaPrimary: "पोर्टल में प्रवेश करें",
      ctaSecondary: "लाइव मंडी देखें",
      stats: [
        {
          label: "सक्रिय एपीएमसी मंडियां",
          val: "1,420+",
          sub: "डिजिटल नेटवर्क से जुड़ी",
        },
        {
          label: "कुल एमएसपी भुगतान",
          val: "₹1,418 करोड़+",
          sub: "सीधा बैंक खाते में",
        },
        {
          label: "प्रमाणित खरीद",
          val: "52 लाख क्विंटल",
          sub: "रबी एवं खरीफ सत्र",
        },
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800 antialiased selection:bg-emerald-500 selection:text-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-950 via-emerald-900 to-slate-900 text-white pt-16 pb-24 px-6">
        ...
        <div className="max-w-6xl mx-auto relative z-10 space-y-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] max-w-4xl mx-auto">
            ...
            <br />
            <span className="text-slate-200 text-3xl sm:text-4xl md:text-5xl font-extrabold">
              {t.heroHeadline3}
            </span>
          </h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pt-12 max-w-5xl mx-auto">
            {t.stats.map((stat, i) => (
              <div
                key={i}
                className="p-4 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md text-left shadow-lg"
              >
      ...
      <section className="max-w-6xl mx-auto px-6 -mt-8 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="group rounded-3xl overflow-hidden shadow-xl border border-slate-200/80 bg-white relative">
            ...
            <div className="p-5 space-y-2">
              <span className="text-[10px] font-bold uppercase tracking-wider bg-amber-100 text-amber-800 px-2.5 py-1 rounded-full">
                Rabi Season Standard
              </span>
              <h3 className="font-bold text-slate-900 text-base">
                Certified Wheat Intake
              </h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                Direct grain moisture inspection, weighing, and instant MSP
                disbursement at ₹2,585 per quintal.
              </p>
            </div>
          </div>
          ...
          <div className="group rounded-3xl overflow-hidden shadow-xl border border-slate-200/80 bg-white relative">
            ...
            />
            <div className="p-5 space-y-2">
              <span className="text-[10px] font-bold uppercase tracking-wider bg-yellow-100 text-yellow-800 px-2.5 py-1 rounded-full">
                Oilseeds Priority
              </span>
              <h3 className="font-bold text-slate-900 text-base">
                Mustard & Oilseed Lines
              </h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                Fast-track weighbridge entry for high-demand oilseeds with
                automated density and dockage tests.
              </p>
            </div>
          </div>
          ...
          <div className="group rounded-3xl overflow-hidden shadow-xl border border-slate-200/80 bg-white relative">
            ...
            <div className="p-5 space-y-2">
              <span className="text-[10px] font-bold uppercase tracking-wider bg-blue-100 text-blue-800 px-2.5 py-1 rounded-full">
                Digitized Yard Scales
              </span>
              <h3 className="font-bold text-slate-900 text-base">
                Tamper-Proof Scales
              </h3>
              <p className="text-xs text-slate-500 leading-relaxed">
                Integrated scale sensors directly commit gross-tare metrics to
                the immutable transaction ledger.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {[
            ...
            <div
              key={idx}
              className="p-6 bg-white rounded-3xl border border-slate-200 shadow-sm space-y-3 relative hover:shadow-md transition"
            >
      ...
      <section className="bg-slate-100/60 border-y border-slate-200 py-16 px-6">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            >
              <Sparkles className="w-3.5 h-3.5 text-amber-500" /> Query All
              Crops with KisanSaathi AI
            </Link>
          </div>
        ...
        <div className="bg-gradient-to-br from-emerald-950 via-slate-900 to-slate-950 rounded-3xl p-6 sm:p-10 border border-emerald-800/50 text-white shadow-2xl space-y-8 relative overflow-hidden">
          <div className="flex flex-col md:flex-row justify-between md:items-center gap-3 border-b border-emerald-800/60 pb-6 relative z-10">
            <div>
              ...
              <h2 className="text-2xl font-black text-white">
                AI Net MSP Settlement Estimator
              </h2>
              <p className="text-xs text-emerald-200/70">
                Simulate fair-price calculations with moisture-based deduction
                logic
              </p>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
              <div>
                <label className="block text-emerald-200/80 mb-1 font-semibold">
                  Commodity
                </label>
                <select
                  value={commodity}
              ...
              <div>
                ...
                <input
                  ...
                  value={quintals}
                  onChange={(e) =>
                    setQuintals(Math.max(1, Number(e.target.value)))
                  }
                  className="w-full bg-slate-800/90 border border-emerald-700/60 rounded-xl p-2.5 text-white font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>
              ...
              <div className="sm:col-span-3 text-[11px] text-emerald-300/80 flex items-center gap-1.5">
                ...
                <span>
                  Standard moisture ceiling is <strong>12.0%</strong>. Readings
                  above threshold trigger standard dockage deduction formulas.
                </span>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-emerald-900/40 p-5 rounded-3xl border border-emerald-700/60 space-y-3 text-xs backdrop-blur-md">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono font-bold text-amber-300">
                  {deductionAmount > 0
                    ? `- ₹${deductionAmount.toLocaleString()} (${moisturePenaltyPct}%)`
                    : "₹0 (Grade A Optimal)"}
                </span>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {schemesList.map((scheme, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-4 hover:border-emerald-400 hover:shadow-md transition"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Check regional mandi traffic on an interactive map, reserve
                arrival windows, generate printable QR gate passes, and download
                digital payment receipts.
              </p>
              <ul className="space-y-2 text-xs font-semibold text-slate-600">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" />{" "}
                  Interactive Mandi Congestion & Distance Map
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Dynamic
                  Gate Entry Pass with encrypted Token
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Instant
                  PDF MSP Settlement Invoicing
                </li>
              </ul>
            </div>
            <Link
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Streamline daily yard intake, verify incoming vehicle tokens,
                record certified gross scale weights and crop quality metrics,
                and log audit entries.
              </p>
              <ul className="space-y-2 text-xs font-semibold text-slate-600">
                <li className="flex items-center gap-2">
      ...
      <footer className="bg-slate-950 text-slate-400 text-xs py-14 px-6 border-t border-slate-800 mt-auto">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3 md:col-span-2">
            ...
            <p className="text-xs leading-relaxed max-w-sm text-slate-400">
              National Agricultural Procurement & Automated Yard Scheduling
              Infrastructure. Enhancing price discovery and DBT disbursals
              across APMC mandi yards.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  ...
                  className="hover:text-emerald-400 transition flex items-center gap-1"
                >
                  PMFBY Portal <ExternalLink className="w-3 h-3" />
                </a>
              </li>
              <li>
                <a
                  ...
                  className="hover:text-emerald-400 transition flex items-center gap-1"
                >
                  e-NAM Mandi Hub <ExternalLink className="w-3 h-3" />
                </a>
              </li>
              <li>
                <a
        ...
        <div className="max-w-6xl mx-auto border-t border-slate-800/80 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-[11px] gap-2">
          ...
          <span>
            © 2026 AgriPulse. Dedicated to Indian Farmers & Transparent Mandi
            Yard Systems.
          </span>
        </div>
      </footer>
